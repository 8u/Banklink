...
class iPizza implements ProtocolInterface
{
     ...
     * @return array
     */
    public function preparePaymentRequestData($orderId, $sum, $message, $outputEncoding, $language = 'EST', $currency = 'EUR', $referencePrefix = null, $is1012request = false, $referenceSuffix = null)
    {
        $now = new \DateTime();
        $requestData = array(
            ...
            Fields::ORDER_REFERENCE  => ProtocolUtils::generateOrderReference($orderId.$referenceSuffix, $referencePrefix),
